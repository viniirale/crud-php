...
$(document).ready(function () {
    ...
    $('.tempoform').mask('00:00:00');
    $('.data_tempoform').mask('00/00/0000 00:00:00');
    $('.cepform').mask('00000-000');
    $('.telform').mask('000000-00000');
    $('.ddd_telform').mask('(00) 00000-0000');
    $('.cpfform').mask('000.000.000-00');
    $('.cnpjform').mask('00.000.000/0000-00');
    $('.dinheiroform').mask('000.000.000.000.000,00', { reverse: true });
    $('.dinheiro2form').mask("#.##0,00", { reverse: true });

    $('.cor_hexform').mask('#xxxxxx', {
    ...
    $('#unmaskform').click(function () {
        var unmask_value = $('.cpfform').cleanVal();
